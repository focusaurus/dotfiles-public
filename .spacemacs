...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(spacemacs-light spacemacs-dark leuven)
...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/exocortex/personal" "~/exocortex/work" "~/mc/mailchimp.org"))
 '(org-todo-keywords '((sequence "NEXT" "TODO" "NOPE" "DONE")))
