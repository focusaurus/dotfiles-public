...
--   log("screen list. Screen count: " .. screen:count())
-- end)
-- screen.connect_signal("added", function()
--   log("screen added. Screen count: " .. screen:count())
-- end)
-- screen.connect_signal("removed", function()
--   log("screen removed. Screen count: " .. screen:count())
-- end)
-- screen.connect_signal("primary_changed", function()
--   log("screen primary_changed. Screen count: " .. screen:count())
-- end)
-- awesome.connect_signal("screen::change", function()
--   log("screen::change. Screen count: " .. screen:count())
-- end)
